...
const EventCard = ({title, description, handleSubmit, handleDecline}: {title: string, description: string, handleSubmit: any, handleDecline: any}) => {
    type Event = {  
        title: string,
        description: string, 
    }
  ...
  return (
    <div className="flex flex-grow justify-center border-4 border-l-0 border-sky-600 w-1/6 h-1/6">
      <div> 
